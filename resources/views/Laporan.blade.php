...
<section class="tentang-section">
    ...
    <div class="table-container" style="background: white; border-radius: 8px; overflow: hidden; margin: 0 20px; box-shadow: 0 4px 15px rgba(0,0,0,0.2);">
            ...
            <div class="modal-content" style="border-radius:12px; border:none; animation: modalFadeIn 0.3s ease; overflow: hidden;">
                ...
                <div class="modal-body" style="background:#faf8f5; padding:20px;">
                    <form id="editTransaksiForm" method="POST">
                        ...
                        <table class="table table-bordered bg-white" style="margin-bottom:0;">
                            <tbody>
                                <tr><td style="background:#bc9c75; color:white; font-size:12px; font-weight:bold;">NAMA</td><td><input type="text" id="modal_nama" class="form-control" readonly></td></tr>
